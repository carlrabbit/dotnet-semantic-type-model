...
`STM0014` reports an invalid Logical Type annotation (invalid name, non-scalar target, or conflicting scalar `TypeRef`).
...
| `TESTDATA_*`  | SemanticTypeModel.TestData deterministic semantic value generation |
