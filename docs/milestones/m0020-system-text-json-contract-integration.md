...
- `docs/specs/compile-time-generator.md`
- `docs/specs/json-schema-runtime-import-export.md`
- `docs/milestones/m0009-dotnet-type-system-extraction-and-compile-time-generator-baseline.md`
- `docs/milestones/m0010-attribute-and-convention-model-for-dotnet-type-extraction.md`
...
If any referenced document does not exist yet, create or update the appropriate document as part of repository alignment before or during implementation.
