...
|---|---|---|
| Code-first JSON Schema | `samples/code-first-json-schema/` | Generated model -> JSON Schema derivation/export |
...
For explanation and options, use the corresponding [public guides](usage.md) rather than adding per-sample
Markdown pages.
