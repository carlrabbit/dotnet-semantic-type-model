...
```sh
dotnet add package SemanticTypeModel.Core --version 2.4.1
dotnet add package SemanticTypeModel.DotNet --version 2.4.1
dotnet add package SemanticTypeModel.Generators --version 2.4.1
dotnet add package SemanticTypeModel.JsonSchema --version 2.4.1
```

Scenario packages:

```sh
dotnet add package SemanticTypeModel.EFCore --version 2.4.1
dotnet add package SemanticTypeModel.PowerBI --version 2.4.1
dotnet add package SemanticTypeModel.SystemTextJson --version 2.4.1
dotnet add package SemanticTypeModel.DependencyInjection --version 2.4.1
```
