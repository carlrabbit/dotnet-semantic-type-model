...
$projects = @('samples/code-first-json-schema/code-first-json-schema.csproj','samples/code-first-ef-core/code-first-ef-core.csproj','samples/code-first-powerbi/code-first-powerbi.csproj','samples/system-text-json-resolver/system-text-json-resolver.csproj','samples/runtime-di/runtime-di.csproj','samples/programmatic-model-catalog/programmatic-model-catalog.csproj')
